class Enrollments {
    public String enrollment1;
    public String enrollment2;
    public String enrollment3;
    public String enrollment4;
    public String enrollment5;
    
    public Enrollments(String enrollment1, String enrollment2, String enrollment3, String enrollment4, String enrollment5) {
        this.enrollment1 = "";
        this.enrollment2 = "";
        this.enrollment3 = "";
        this.enrollment4 = "";
